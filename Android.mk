...
LOCAL_CFLAGS += -std=c++20 #-funwind-tables -Ofast -ffast-math -mllvm -polly
LOCAL_CFLAGS += -D_LIB -DNOMINMAX -D_USE_MATH_DEFINES -D__STDC_NO_THREADS__ -D__STDC_VERSION__=199901L -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DUTIL_ARCH_LITTLE_ENDIAN
#LOCAL_CFLAGS += -DNOX11
